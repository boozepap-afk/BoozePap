...
export const ORDER_STATUS_TRANSITIONS: Record<OrderStatus, readonly OrderStatus[]> = {
  pending: ['dispatched','cancelled'], awaiting_payment: ['paid','cancelled'], paid: ['dispatched','cancelled'],
  confirmed: ['dispatched','cancelled'], preparing: ['dispatched','cancelled'], ready_for_dispatch: ['dispatched','cancelled'],

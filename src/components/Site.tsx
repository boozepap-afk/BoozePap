...
export function Header({ content = {}, products = [] }: { content?: SiteContent; products?: DbProduct[] }) {
  ...
  return <header className="sticky top-0 z-40 bg-brand-ink text-white shadow-lg">
    ...
    <div className="mx-auto flex max-w-[1440px] flex-wrap items-center gap-3 px-3 py-3 sm:px-6">
